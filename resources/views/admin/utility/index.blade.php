                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="{{route('admin.utility.getAddUtility')}}" class="btn btn-success btn-md">Thêm</a>
                                </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                @foreach($listUti as $utility)
                                    <tr class="gradeX">
                                        <td>{{$utility->uid}}</td>
                                        <td>{{$utility->uname}}</td>
                                        <td class="center">
                                            <a href="{{route('admin.utility.getEditUtility', $utility->uid)}}" title=""
                                               class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                            <a href="{{route('admin.utility.deleteUtility', $utility->uid)}}" title=""
                            ...
                            {{--<div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="dataTables-example_info"
                                         style="margin-top:27px">Hiển thị từ 1 đến 5 của 24 truyện
                                    </div>
                                </div>
                                <div class="col-sm-6" style="text-align: right;">
